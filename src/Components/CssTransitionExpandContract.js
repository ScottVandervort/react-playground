...
/* https://stackoverflow.com/questions/37677059/slideup-and-slidedown-animation-using-react-js 
  ...
  Css transitions only work with fixed-height containers. If container is NOT fixed height should use Javascript-based transition instead.

*/
class CssTransitionExpandContract extends React.Component {
    ...
    render() {
      ...
      return (
        <div>
            <h3>Expand/Contract - Css</h3>  
            <p>Using Css and the React CSSTransitionGroup component only works well for statically sized elements.</p>
            <section className="css-transitions">           
                {itemsAsComponents}             
              </section>
        </div>
      );
        ...
        return(
          <article>
            ...
            <CSSTransitionGroup 
              ...
              transitionName="expand-contract">  
              { this.state.visible ? <div className='panel'>{this.props.desc}</div> : null }                           
            </CSSTransitionGroup>            
          </article>
        );
    }  
  ...
  export default CssTransitionExpandContract;